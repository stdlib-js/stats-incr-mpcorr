...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof incrmpcorr, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an accumulator function', function test( t ) {
	t.strictEqual( typeof incrmpcorr( 3 ), 'function', 'returns expected value' );
	t.end();
});

tape( 'the function returns an accumulator function (known means)', function test( t ) {
	t.strictEqual( typeof incrmpcorr( 3, 3.0, 3.14 ), 'function', 'returns expected value' );
	t.end();
});
